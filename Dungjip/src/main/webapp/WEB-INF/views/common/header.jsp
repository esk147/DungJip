...
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/normalize.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/font-awesome.min.css">
<link rel="stylesheet" href="/dungjip/resources/assets/css/fontello.css">
<link
	href="/dungjip/resources/assets/fonts/icon-7-stroke/css/pe-icon-7-stroke.css"
	rel="stylesheet">
<link
	href="/dungjip/resources/assets/fonts/icon-7-stroke/css/helper.css"
	rel="stylesheet">
<link href="/dungjip/resources/assets/css/animate.css" rel="stylesheet"
	media="screen">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/bootstrap-select.min.css">
<link rel="stylesheet"
	href="/dungjip/resources/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/icheck.min_all.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/price-range.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/owl.carousel.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/owl.theme.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/owl.transitions.css">
<link rel="stylesheet" href="/dungjip/resources/assets/css/style.css">
<link rel="stylesheet"
	href="/dungjip/resources/assets/css/responsive.css">

<noscript>
	<link rel="stylesheet" type="text/css"
		href="/dungjip/resources/assets/css/styleNoJS.css" />
</noscript>
	...
	<nav class="navbar navbar-default ">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/dungjip"><img src="" alt="">
				<p>DungJip</p></a>
			</div>
			...
			<c:choose>
					...
					<div class="collapse navbar-collapse yamm" id="navigation">
						<div class="button navbar-right">
							<button class="navbar-btn nav-button wow bounceInRight"
								onclick='location.href="login.be"' data-wow-delay="0.4s">Login</button>
							<button class="navbar-btn nav-button wow fadeInRight" onclick=''
								data-wow-delay="0.5s">QnA</button>
						</div>
						<ul class="main-nav nav navbar-nav navbar-right">
							<li class="dropdown ymm-sw " data-wow-delay="0.1s"><a
								href="villa.map" class="active">빌라</a></li>
				...
				<c:otherwise>
					...
					<div class="collapse navbar-collapse yamm" id="navigation">
						<div class="button navbar-right">
							<button class="navbar-btn nav-button wow bounceInRight"
								onclick='location.href="logout.me"' data-wow-delay="0.4s">Logout</button>
							<button class="navbar-btn nav-button wow fadeInRight" onclick=''
								data-wow-delay="0.5s">QnA</button>
						</div>
						<ul class="main-nav nav navbar-nav navbar-right">
							...
							<li class="dropdown ymm-sw" data-wow-delay="0.1s"><a
								...
								data-hover="dropdown" data-delay="200"> <c:choose>
