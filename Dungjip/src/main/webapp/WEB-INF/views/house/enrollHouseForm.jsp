      ...
      <div class="grid grid-2 py-4">
          ...
          <div class="select-container">
            <select id="houseType" name="houseType">
              <option value="" disabled selected hidden>매물을 선택해주세요</option>
        ...
        <div class="col">
          ...
          <div class="select-container">
            <select id="houseStyle" name="houseStyle">
              <option value="" disabled selected hidden>월세/전세</option>
		...
		<div id="map" style="width: 40%; height: 400px;"></div>
			<div class="grid grid-2">
				<div class="col">
					...
					<input type="text" id="houseLatitude" name="houseLatitude" class="input" required>
				</div>
				<div class="col">
					<label class="label">경도</label>
					<input type="text" id="houseLongitude" name="houseLongitude" class="input" required>
				</div>
			</div>
      </div>
      <br>
        ...
        <div class="col">
          ...
          <input class="input" id="houseBuildingFloor" name="houseBuildingFloor" placeholder="집 층수" />
        </div>

        <h2 class="title margin-bottom">추가정보</h2>
        <div class="grid grid-2">
          <div class="col">
          ...
          <div class="col">
            ...
            <input class="input" id="houseRooms" name="houseRooms" placeholder="화장실 개수" />
          </div>
        </div>
        <div class="grid-single">
          <div>
            <label class="label">옵션</label> <br>
            <div class="badge-container">
	        <label for="houseParkAble">주차 가능 여부:</label>
		        ...
		        <label for="houseBalcony">베란다 여부:</label>
		        <br>
		        ...
		        <label for="houseDoItNow">즉시 입주 가능 여부:</label>
	            ...
	            <div class="col">
	              ...
	              <input class="input" id="houseBulidDate" name="houseBuildDate" placeholder="준공 날짜(YY/MM/dd)" />
	            </div>
			    <label for="houseAnimals">반려동물 가능 여부:</label>
